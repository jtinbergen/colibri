...
static void model_init(Model *m, const char *snap, int cap, int bits) {
    ...
    m->lm_head.f32  = load_t(m, "lm_head.weight");
    ...
    for (int i = 0; i < c->n_layers; i++) {
        ...
        LD2(sh_g.f32, "gate_proj.weight"); LD2(sh_u.f32, "up_proj.weight"); LD2(sh_d.f32, "down_proj.weight");
        #undef LD2
        ...
        if (c->is_attn[i]) {
            ...
            LD3(q.f32, "q_proj.weight"); LD3(k.f32, "k_proj.weight");
            LD3(v.f32, "v_proj.weight"); LD3(o.f32, "o_proj.weight");
            #undef LD3
            ...
            LD4(dn_qkv.f32, "in_proj_qkv.weight"); LD4(dn_z.f32, "in_proj_z.weight");
            ...
            LD4(dn_out.f32, "out_proj.weight");
            #undef LD4
        }
    }
